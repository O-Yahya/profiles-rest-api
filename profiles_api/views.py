...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    """Handle creating and modifying profile feed items"""
    #Adding authentication method
    authentication_classes = (TokenAuthentication, )
    #Setting viewset serializer to created serializer
    serializer_class = serializers.ProfileFeedItemSerializer
    #Setting query to be managed by this viewset to all profile feed item objects
